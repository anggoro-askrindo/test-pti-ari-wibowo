...
@Slf4j
public class TransactionConditionalValidator implements ConstraintValidator<TransactionConditional, Object> {
    ...
    @Override
    public void initialize(TransactionConditional requiredIfChecked) {
